...
if ( url.indexOf( "?" ) != -1 ) {
  ...
  console.log( decodeURI(theRequest.title) ); //此时的theRequest就是我们需要的参数；

    $("#box1 > .show").html(`<img src="${theRequest.img}" alt=""><div class="mask"></div>`)
    $("#box1 > .list").html(`<p class="active">
    <img src="${theRequest.img}"  show="${theRequest.img}"  enlarge="${theRequest.img}" alt="">
  </p>
  <p>
    <img src="../images/index/test2.png" show="../images/index/test2.png" enlarge="../images/index/test2.png" alt="">
    <!-- <img src="../images/index/test2.png" show="./imgs/show1.jpg" enlarge="./imgs/big1.jpg" alt=""> -->
  </p>`)
    $("#bigbox-container > .right>h3").html(`<img src="https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/1e455ea5dca7763e88f7a4bfface056d.jpg?w=165&h=55" alt=""> ${decodeURI(theRequest.title)}`)

    $("#price").text(theRequest.price)
    $("#price-2").text(theRequest.price)
}
// /*
